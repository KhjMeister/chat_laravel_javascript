    ...
    */
    ...
    protected function create(array $data): User
    {
        ...
        try {
            ...
            throw new HttpException(500, 'ثبت نام با شکست مواجه شد.');
        }
    ...
    private function makeUser(array $data): void
    {
        ...
        // $data->file('files1')->move(public_path('images'), '1.jpg');
        // if($req->file()) {
        //     $fileName = time().'_'.$data->file->getClientOriginalName();
        //     $filePath = $data->file('files1')->storeAs($data['name'], '1.jpg', 'public');
    ...
    private function setupUserWithDemo(): void
    {
        ...
        MessengerComposer::to($this->newUser)
            ->from($admin)
            ->message('به ویدیو رایان خوش آمدید!');
    }
}
