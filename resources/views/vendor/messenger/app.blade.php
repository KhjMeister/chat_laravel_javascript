...
<wrapper class="d-flex flex-column">
    <nav id="FS_navbar" class="navbar fixed-top navbar-expand-lg navbar-light bg-light {{request()->is('messenger/*') && app('agent')->isMobile() ? 'NS' : ''}}">
        <a class="navbar-brand" href="{{url('/')}}">
            <img src="{{ asset('vendor/messenger/rv/img/logo.gif') }}"  height="30" class="d-inline-block align-top" alt="Messenger">
