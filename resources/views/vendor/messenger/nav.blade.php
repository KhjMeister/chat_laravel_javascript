...
<ul class="navbar-nav mb-1">
    <li id="active_calls_nav" class="nav-item dropdown mx-1 my-2 my-lg-0">
        ...
        <div class="dropdown-menu dropdown-menu-left notify-drop bg-light" aria-labelledby="click_friends_tab">
            <div class="col-12 text-center">
                <h6 class="font-weight-bold">تماس های فعال</h6>
                <hr class="mt-n1 mb-2">
            </div>
    ...
    <li id="pending_friends_nav" class="nav-item dropdown mx-1 my-2 my-lg-0">
        ...
        <div class="dropdown-menu dropdown-menu-left notify-drop bg-light" aria-labelledby="click_friends_tab">
            <div class="row">
                <div class="col-12 pill-tab-nav">
                    <nav id="nav-friend-tabs" class="nav nav-pills flex-column flex-sm-row" role="tablist">
                        <a class="flex-sm-fill text-sm-center nav-link h6 active" id="tab-pending" data-toggle="pill" href="#f_pending" role="tab" aria-controls="f_pending" aria-selected="true"><i class="fas fa-user-friends"></i> در حال ارسال</a>
                        <a class="flex-sm-fill text-sm-center nav-link h6" id="tab-sent" data-toggle="pill" href="#f_sent" role="tab" aria-controls="f_sent" aria-selected="false"><i class="fas fa-user-friends"></i> ارسال شده</a>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12 text-center mt-2 pb-4 pb-lg-3">
                <hr class="mb-1 mt-0">
                <span class="float-right"><a class="nav-search-link text-dark" href="#">یافتن دوستان <i class="fas fa-search"></i> </a></span>
            </div>
        </div>
    </li>
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="user_nav_dp">
            <a onclick="Messenger.forms().Logout(); return false;" class="dropdown-item"  href="#"><i class="fas fa-sign-out-alt"></i> خروج</a>
            <!-- <a href="{{ route('logout') }}" class="dropdown-item"  href="#"><i class="fas fa-sign-out-alt"></i> خروج</a> -->
        </div>
    </li>
</ul>
